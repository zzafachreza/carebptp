...
export default function ({ navigation }) {
    ...
    const [rating, setRating] = useState({
        nama_layanan: 'Layanan Uji Tanah dan Pupuk',
        rating1: '',
        rating2: '',
        rating3: '',
        nama_user: data.nama
    ...
    const kirim = () => {
        ...
        if (data.nama.length === 0) { showMessage({ message: 'Maaf nama masih kosong !' }); }
            ...
            axios
                .post('https://carebptp.zavalabs.com/api/1add_lab.php', data)
                .then(x => {
            ...
            <ScrollView
                ...
                <MyPicker
                    ...
                    data={[
                        ...
                        {
                            label: 'Pengujian tanah kering',
                            value: 'Pengujian tanah kering',
                        },
                        {
                            label: 'Pengujian tanah rawa',
                            value: 'Pengujian tanah rawa',
                        },
                        {
                            label: 'Pengujian pupuk organik',
                            value: 'Pengujian pupuk organik',
                        },
